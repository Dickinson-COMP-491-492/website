...
The reading assignments thus far this semester have focused on ethical reasoning. In this assignment and the next you identify a real-world cases study of interest, perform an ethical analysis of your case study based on the [Markkula Center's Framework for Ethical Decision Making](https://www.scu.edu/ethics/ethics-resources/a-framework-for-ethical-decision-making/) and the [ACM's Code of Ethics and Professional Conduct](https://www.acm.org/code-of-ethics), and produce a public facing-blog post that summarizes your analysis.
...
Add to your document by adding responses for the first 6 steps of the [Markkula Center's Framework for Ethical Decision Making](https://www.scu.edu/ethics/ethics-resources/a-framework-for-ethical-decision-making/). The numbered entries below provide additioanl context for each step as related to this assignment.

1. First, briefly describe the roles (e.g. sofware engineer, manager, lawyer, etc.) of the key decision makders in your case and the decisions that they made. Then, respond to the framework questions for each of those roles and decisions.
2. The answer to this should be yes given the guidance for selecting a case study. If not, you will need to reconsider the case study you selected.
...
1. Create a `COMP492` folder in your [Dickinson WiD Repository](https://github.com/Dickinson-COMP-WiD) on GitHub.
2. Place a PDF of your document named `WA04-CaseAnalysis.pdf` in your `COMP492` folder.
