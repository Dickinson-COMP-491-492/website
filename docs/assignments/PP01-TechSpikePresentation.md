...
- **Timing:** Meet the target length for the presentation within plus or minus 2 minutes.  The target time for your presentation will be set as follows:
    - 5 minutes for project introduction and conclusions.
    - 5 minutes for each demonstration, where teams will use the minimum number of demonstrations necessary to ensure that all members are involved in the demonstration of at least one artifact that they built or helped to build.
    - For example: A team of 4 may need two demonstrations, so the target time for their presentation would be 5 + 5*2 or 15 minutes.
    - There will be an additional 3-7 minutes of question and answer time following the presentation.
...
- **Presentation Materials:** The presentation materials should:
  ...
  - be accessible via a link on the team's page in the course repository.
